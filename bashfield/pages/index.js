...
export default function Home() {
  ...
  const hasActiveFilters = useMemo(() => {
    return filters.city || filters.rooms || filters.minPrice > 0 || filters.maxPrice < 5000
  }, [filters])
            ...
            <div className="max-w-5xl mx-auto mb-12">
              <div className="bg-white/95 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 p-8">
                <div className="text-center mb-6">
                  <h3 className="text-2xl font-bold text-gray-900 mb-2">Find Your Perfect Home</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                  ...
                  <div className="space-y-2">
                    <label className="block text-sm font-semibold text-gray-700">🛏️ Rooms</label>
                    <select
                      value={filters.rooms}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            <div className="group bg-gradient-to-br from-blue-50 to-indigo-100 rounded-3xl p-8 hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-4 text-center border border-blue-200/50">
              ...
              <div className="text-3xl sm:text-4xl font-bold text-blue-600 mb-2 group-hover:scale-110 transition-transform">{statsData.totalListings}+</div>
            ...
            <div className="group bg-gradient-to-br from-green-50 to-emerald-100 rounded-3xl p-8 hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-4 text-center border border-green-200/50">
              ...
              <div className="text-3xl sm:text-4xl font-bold text-green-600 mb-2 group-hover:scale-110 transition-transform">{statsData.totalCities}</div>
