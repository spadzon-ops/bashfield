        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 lg:py-32">
          <div className="text-center">
            ...
            <p className="text-xl sm:text-2xl text-gray-200 mb-12 max-w-4xl mx-auto leading-relaxed">
              Discover premium rental properties across Iraq's major cities with our AI-powered search.
              <span className="block mt-2 text-yellow-300 font-semibold">Verified listings • Instant messaging • Secure platform</span>
            </p>
                ...
                <div className="flex flex-col lg:flex-row gap-4 mb-6">
                  <div className="flex-1 relative">
                    ...
                    <input
                      ...
                      className="w-full pl-12 pr-4 py-4 text-lg border-2 border-gray-200 rounded-2xl focus:ring-4 focus:ring-purple-500/20 focus:border-purple-500 transition-all"
                    />
                  </div>
                  <button
                    onClick={() => setShowFilters(!showFilters)}
                    className="px-6 py-4 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-2xl transition-all flex items-center space-x-2 lg:w-auto w-full justify-center"
                  >
                  ...
                  <button
                    ...
                    className="px-8 py-4 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-bold rounded-2xl transition-all transform hover:scale-105 shadow-lg hover:shadow-xl flex items-center space-x-2 lg:w-auto w-full justify-center"
                  >
                    <span>🔍</span>
                    <span>Search</span>
                  </button>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 pt-6 border-t border-gray-200">
                    ...
                    <div className="flex space-x-2">
                      <select
                        ...
                        className="w-20 px-2 py-3 border-2 border-gray-200 rounded-xl focus:ring-4 focus:ring-purple-500/20 focus:border-purple-500 transition-all text-sm"
                      >
                      ...
                      <input
                        ...
                        className="flex-1 px-3 py-3 border-2 border-gray-200 rounded-xl focus:ring-4 focus:ring-purple-500/20 focus:border-purple-500 transition-all"
                      />
                    </div>
                    
                    <button
                      onClick={clearFilters}
                      className="w-full px-4 py-3 bg-red-100 hover:bg-red-200 text-red-700 rounded-xl transition-all flex items-center justify-center space-x-2"
                    >
                      <span>🗑️</span>
                      <span>Clear</span>
                    </button>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <button 
                ...
                className="group bg-gradient-to-r from-yellow-400 via-orange-500 to-red-500 hover:from-yellow-500 hover:via-orange-600 hover:to-red-600 text-white font-bold py-6 px-12 rounded-2xl text-xl transition-all duration-500 shadow-2xl hover:shadow-3xl transform hover:-translate-y-3 hover:scale-110"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Join Iraq's fastest-growing rental community with verified properties and instant connections
            </p>
          </div>
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            ...
            <div className="group bg-gradient-to-br from-green-50 to-emerald-100 rounded-3xl p-8 hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-4 text-center border border-green-200/50">
              ...
              <div className="text-gray-500 text-sm">Across Iraq</div>
            </div>
            <div className="group bg-gradient-to-br from-purple-50 to-violet-100 rounded-3xl p-8 hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-4 text-center border border-purple-200/50">
              ...
              <div className="text-3xl sm:text-4xl font-bold text-purple-600 mb-2 group-hover:scale-110 transition-transform">100%</div>
              <div className="text-gray-700 font-semibold text-lg mb-1">Verified</div>
              <div className="text-gray-500 text-sm">All properties</div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-12 leading-relaxed">
              Discover exceptional rental opportunities across Iraq's major cities with our curated collection of verified properties
            </p>
