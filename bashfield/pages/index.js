            ...
            <div className="max-w-6xl mx-auto mb-12">
              <div className="bg-white/95 backdrop-blur-lg rounded-3xl shadow-2xl p-6 sm:p-8 border border-white/20">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-3">💵 Price Range (USD)</label>
                    <div className="bg-white rounded-xl p-4 border-2 border-gray-200">
                      ...
                      <div className="flex justify-between items-center">
                        <div className="bg-blue-50 px-3 py-2 rounded-lg">
                          ...
                          <div className="font-bold text-blue-600">${filters.minPrice.toLocaleString()}</div>
                        </div>
                        <div className="text-gray-400">—</div>
                        <div className="bg-blue-50 px-3 py-2 rounded-lg">
                          <span className="text-xs text-gray-600">Max</span>
                          <div className="font-bold text-blue-600">${filters.maxPrice.toLocaleString()}</div>
                        </div>
                      </div>
                    </div>
                  </div>
