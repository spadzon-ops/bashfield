              ...
              <div className="bg-white/95 backdrop-blur-lg rounded-3xl shadow-2xl p-6 sm:p-8 border border-white/20">
                ...
                <div className="flex flex-col lg:flex-row gap-4 mb-6">
                  ...
                  <button
                    ...
                    className="px-8 py-4 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-bold rounded-2xl transition-all transform hover:scale-105 shadow-lg hover:shadow-xl flex items-center space-x-2 lg:w-auto w-full justify-center"
                  >
                    <span>🔍</span>
                    <span>Search</span>
                  </button>
