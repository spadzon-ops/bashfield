              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-3 rounded-xl bg-white/10 backdrop-blur-sm text-white border border-white/20 focus:border-white/40 transition-all"
                    >
                    ...
                    <div className="bg-white/10 backdrop-blur-sm rounded-xl p-3 border border-white/20">
                      <div className="flex items-center space-x-3 mb-2">
                        <input
                          ...
                          className="w-20 px-2 py-1 text-sm rounded bg-white/20 text-white placeholder-white/70 border border-white/30"
                        />
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-6">
              ...
              <div className="inline-flex bg-white rounded-2xl shadow-lg p-2 border border-gray-200">
                ...
                <button
                  ...
                  className={`px-8 py-4 rounded-xl font-bold transition-all duration-300 flex items-center space-x-2 border-2 shadow-lg ${
                    viewMode === 'map'
                      ? 'bg-gradient-to-r from-blue-600 to-blue-700 text-white shadow-xl transform scale-110 border-blue-500 animate-pulse'
                      : 'text-blue-600 hover:text-blue-700 hover:bg-blue-50 border-blue-200 hover:border-blue-400 bg-white'
                  }`}
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
                  <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white p-6 text-center">
                    <div className="flex items-center justify-center space-x-3 mb-2">
                      ...
                      <h3 className="text-2xl font-bold">Property Map</h3>
                    </div>
                    <p className="text-blue-100">Explore {filteredListings.length} properties by location</p>
                  </div>
                  <div className="h-96">
                    <MapView 
