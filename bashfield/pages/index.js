...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
                    ...
                    <div className="space-y-3">
                      <div className="relative">
                        ...
                        <input
                          ...
                          style={{
                            background: `linear-gradient(to right, #e5e7eb 0%, #e5e7eb ${(filters.minPrice/5000)*100}%, #3b82f6 ${(filters.minPrice/5000)*100}%, #3b82f6 ${(filters.maxPrice/5000)*100}%, #e5e7eb ${(filters.maxPrice/5000)*100}%, #e5e7eb 100%)`
                          }}
                        />
                      </div>
      ...
      <div id="listings" className="bg-gradient-to-b from-gray-50 to-white py-12 sm:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <>
              ...
              {viewMode === 'map' && (
                <div className="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-3xl p-8 border-2 border-blue-200 shadow-xl">
                  <div className="text-center mb-8">
                    <div className="w-20 h-20 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl flex items-center justify-center mx-auto mb-4 animate-pulse">
                      <span className="text-3xl text-white">🗺️</span>
                    </div>
                    <h3 className="text-3xl font-bold bg-gradient-to-r from-blue-700 to-indigo-700 bg-clip-text text-transparent mb-3">Interactive Property Map</h3>
                    <p className="text-lg text-gray-700 font-medium">Explore {filteredListings.length} properties by location</p>
                  </div>
                  <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-2 border border-blue-300">
                    <MapView 
