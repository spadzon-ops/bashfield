...
import PropertyDescriptionTranslator from '../../components/PropertyDescriptionTranslator'
            ...
            <div className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl p-8 lg:p-10 mt-8 border border-gray-200/50">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <a 
                        ...
                        className="font-semibold text-gray-900 hover:text-purple-600 transition-colors cursor-pointer notranslate"
                        data-username="true"
                      >
              ...
              <div className="mb-8">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <SimpleTranslate onLanguageChange={setSelectedLang} />
                </div>
                <PropertyDescriptionTranslator 
                  listing={listing} 
              ...
              <div className="flex flex-col items-center">
                ...
                >
                  ...
                  <div className="mt-4 text-center">
                    <h3 className="text-xl font-bold text-gray-900 group-hover:text-blue-600 transition-colors notranslate" data-username="true">
                ...
                <div className="w-full mt-6 space-y-3">
                  ...
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white font-bold py-3 px-6 rounded-xl transition-all duration-300 flex items-center justify-center space-x-2 transform hover:scale-105 shadow-lg hover:shadow-xl group"
                  >
