              ...
              <div className="flex flex-col items-center">
                ...
                <div className="w-full mt-6 space-y-3">
                  <FavoriteButton 
                    ...
                    className="w-full bg-gradient-to-r from-red-500 to-pink-500 hover:from-red-600 hover:to-pink-600 text-white font-bold py-3 px-6 rounded-xl transition-all duration-300 flex items-center justify-center space-x-2 transform hover:scale-105 shadow-lg hover:shadow-xl"
                  />
                  <button
