          ...
          <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-6">
            ...
            <div className="text-center sm:text-left flex-1">
              <div className="flex items-center gap-3 mb-2">
                ...
                {profile?.is_verified && (
                  <span className="text-blue-500 text-xl" title="Verified User">✓</span>
                )}
              </div>
              <p className="text-gray-600 mb-2 font-mono text-sm bg-gray-100 px-2 py-1 rounded inline-block">
                📧 {profile?.email}
              </p>
                ...
                {userListings.map(listing => (
                  <div key={listing.id} className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow">
                    ...
                    <div className="p-4">
                      ...
                      <p className="text-sm text-gray-600 mb-2">#{listing.reference_code}</p>
                      <p className="text-sm text-gray-600 mb-3">${Number(listing.price).toLocaleString()}</p>
                      <div className="flex gap-2">
                        ...
                        <button onClick={() => deleteUserListing(listing.id)}
