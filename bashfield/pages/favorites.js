      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        {favorites.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 mb-4">Start exploring properties and save the ones you love!</p>
            <button 
              onClick={() => router.push('/')}
              ...
              {favorites.map(listing => (
                <div key={listing.id} className="relative">
                  ...
                  <button
                    ...
                    className="absolute top-2 right-2 w-8 h-8 bg-red-500 hover:bg-red-600 text-white rounded-full flex items-center justify-center transition-colors z-10 shadow-lg"
