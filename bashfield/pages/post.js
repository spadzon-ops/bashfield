      ...
      <div className="bg-white/80 backdrop-blur-sm shadow-lg border-b border-gray-100">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center">
            ...
            <h1 className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-blue-600 to-blue-700 bg-clip-text text-transparent mb-3">List Your Property</h1>
            <p className="text-gray-600 text-lg">Reach thousands of potential tenants across Iraq</p>
          </div>
              ...
              <div className="space-y-6">
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:border-blue-500 transition-colors">
                  ...
                  <label htmlFor="image-upload" className="cursor-pointer">
                    ...
                    <div className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg inline-block transition-colors">
                      Choose Images
                    </div>
                  </label>
                </div>
