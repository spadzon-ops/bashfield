...
export default function Profile() {
  ...
  const [displayedListings, setDisplayedListings] = useState(10)
              ...
              <div>
                {userListings.length === 0 ? (
                  ...
                  <div>
                    ...
                    {userListings.filter(listing => listing.status === 'approved' && listing.is_active !== false).length > displayedListings && (
                      <div className="text-center mt-8">
                        <button
                          onClick={() => {
                            setLoadingMore(true)
                            setTimeout(() => {
                              setDisplayedListings(prev => prev + 10)
