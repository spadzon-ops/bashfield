  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-gradient-to-r from-white to-blue-50 rounded-2xl shadow-xl p-8 sm:p-10 mb-10 border border-gray-100">
        ...
        <div className="bg-white rounded-2xl shadow-xl mb-10 border border-gray-100 overflow-hidden">
