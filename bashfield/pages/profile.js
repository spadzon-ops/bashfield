            ...
            {activeTab === 'profile' && (
              <div className="max-w-2xl space-y-8">
                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-200/50">
                  ...
                  <p className="text-gray-600 mb-6">Your profile information is displayed on your listings and when other users view your profile. You can edit your name and bio by clicking the edit icons above.</p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <div className="bg-white rounded-lg p-3 border border-gray-200">
                        ...
                        <span className="text-xs text-gray-400 ml-2">({displayName.length}/50)</span>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="bg-white rounded-lg p-3 border border-gray-200 min-h-[60px]">
                        <span className="text-gray-900 text-sm">{bio || 'No bio added'}</span>
                        {bio && <span className="text-xs text-gray-400 ml-2">({bio.length}/160)</span>}
                      </div>
                    </div>
                  </div>
                </div>
