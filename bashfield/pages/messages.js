  ...
  return (
    <div className="h-screen bg-gradient-to-br from-gray-50 to-gray-100 overflow-hidden">
      <div className="h-full flex flex-col">
        <div className="bg-white/95 backdrop-blur-sm shadow-2xl h-full min-h-0 border-b border-gray-200/50 overflow-hidden">
              ...
              <div className="p-6 border-b border-gray-200/50 flex-none bg-gradient-to-r from-purple-50 to-pink-50">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">{t('Your conversations')}</p>
                  </div>
                </div>
              </div>
              <div className="flex-1 min-h-0 overflow-y-auto">
                {conversations.length === 0 ? (
                  <div className="p-8 text-center">
                    ...
                    <h3 className="text-lg font-semibold text-gray-900 mb-2">{t('No conversations yet')}</h3>
                    <p className="text-gray-600">{t('Start browsing properties to connect with owners')}</p>
                  </div>
                ) : (
                      ...
                      <div className="flex items-center space-x-4">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center justify-between mb-1">
                            <p className={`font-semibold truncate notranslate ${
                          ...
                          <p className={`text-sm truncate mb-1 ${
                            ...
                            {conversation.listing?.title ? `🏠 ${conversation.listing.title}` : `💬 ${t('Direct Message')}`}
                          </p>
                          {conversation.last_message && (
                  ...
                  <div className="p-6 border-b border-gray-200/50 bg-gradient-to-r from-white to-gray-50 flex-none">
                    <div className="flex items-center space-x-4">
                      ...
                      <Link href={`/profile/${activeConversation.other_participant?.user_id || ''}`} className="flex items-center space-x-4 group hover:bg-blue-50 rounded-2xl p-3 -m-3 transition-all duration-300">
                        ...
                        <div>
                          <h3 className="font-bold text-gray-900 group-hover:text-blue-600 transition-colors text-lg notranslate" data-username="true">
                            {activeConversation.other_participant?.display_name || 'Unknown User'}
                          </h3>
                          <p className="text-sm text-blue-600 font-medium">
                            {activeConversation.listing?.title ? `🏠 ${activeConversation.listing.title}` : `💬 ${t('Direct Message')}`}
                          </p>
                        </div>
                      </Link>
                      ...
                      return (
                        <div key={m.id} className={`flex items-end space-x-3 ${isMe ? 'justify-end flex-row-reverse space-x-reverse' : 'justify-start'}`}>
                          ...
                          <div className={`max-w-xs lg:max-w-md ${isLastInGroup ? 'mb-2' : 'mb-1'}`}>
                            ...
                            >
                              <p className="text-sm whitespace-pre-wrap break-words leading-relaxed notranslate" style={{ overflowWrap: 'anywhere', wordBreak: 'break-word' }} data-message="true">
                                {m.content}
                              </p>
                            </div>
                            {isLastInGroup && (
                ...
                <div className="flex-1 flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100">
                  <div className="text-center max-w-md mx-auto p-8">
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      {t('Choose a conversation from the list to start messaging with property owners and potential tenants')}
                    </p>
                  </div>
                </div>
              )}
