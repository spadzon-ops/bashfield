            ...
            <div className={`${activeConversation ? 'hidden md:flex' : 'flex'} w-full md:w-1/3 border-r border-gray-200/50 flex-col min-h-0 relative z-10 bg-gradient-to-b from-white to-gray-50`}>
              <div className="p-6 border-b border-gray-200/50 flex-none bg-gradient-to-r from-purple-50 to-pink-50">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h2 className="text-xl font-bold bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">Messages</h2>
                    ...
                    <div
                      ...
                      className={`p-4 mx-3 my-2 rounded-2xl cursor-pointer transition-all duration-300 hover:shadow-lg ${
                        activeConversation?.id === conversation.id 
                          ...
                          : 'bg-white hover:bg-gray-50 border border-gray-200/50 hover:border-purple-200'
                      }`}
                    >
                      <div className="flex items-center space-x-4">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className={`text-sm truncate mb-1 ${
                            ...
                            🏠 {conversation.listing?.title || 'Property'}
                          </p>
                          {conversation.last_message && (
                  ...
                  <div className="p-6 border-b border-gray-200/50 bg-gradient-to-r from-white to-gray-50 flex-none">
                    <div className="flex items-center space-x-4">
                      <button 
                        ...
                        className="md:hidden text-gray-600 hover:text-purple-600 p-2 rounded-xl hover:bg-purple-50 transition-all duration-300"
                      >
                      ...
                      <Link href={`/profile/${activeConversation.other_participant?.user_id || ''}`} className="flex items-center space-x-4 group hover:bg-purple-50 rounded-2xl p-3 -m-3 transition-all duration-300">
                        <div className="relative">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-purple-600 font-medium">
                            🏠 {activeConversation.listing?.title || 'Property'}
                          </p>
                        </div>
                      </Link>
                      ...
                      <div className="ml-auto flex items-center space-x-2">
                        <button className="p-2 text-gray-600 hover:text-purple-600 hover:bg-purple-50 rounded-xl transition-all duration-300">
                    ...
                    <form className="flex space-x-4 items-end" onSubmit={(e) => { e.preventDefault(); sendMessage() }} autoComplete="off">
                      <div className="flex-1 relative">
                        <textarea
                          ...
                          className="w-full px-4 py-3 pr-12 border-2 border-gray-200 rounded-2xl focus:ring-4 focus:ring-purple-500/20 focus:border-purple-500 resize-none overflow-hidden min-h-[52px] max-h-32 transition-all duration-300 bg-gray-50 focus:bg-white"
                          disabled={sending}
                          rows={1}
                          name="message"
                          id="message"
                      ...
                      <button
                        ...
                        className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 disabled:from-gray-400 disabled:to-gray-400 text-white p-3 rounded-2xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl disabled:transform-none disabled:shadow-none flex items-center justify-center min-w-[52px]"
                      >
                        {sending ? (
...
function AvatarCircle({ profile, size = 40 }) {
  ...
  return (
    <div 
      className="rounded-full bg-gradient-to-r from-purple-500 to-pink-500 flex items-center justify-center ring-2 ring-white shadow-lg" 
      style={{ width: size, height: size }}
    >
