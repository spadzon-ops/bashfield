...
create index if not exists idx_listings_desc_ku on public.listings(description_ku);
create index if not exists idx_listings_desc_ar on public.listings(description_ar);
