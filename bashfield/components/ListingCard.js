      ...
      <div className={`${!showActions ? 'cursor-pointer' : ''}`} onClick={!showActions ? openListing : undefined}>
        ...
        >
          ...
          <button 
            ...
            className={`absolute top-3 right-3 w-10 h-10 backdrop-blur-sm rounded-full flex items-center justify-center transition-all duration-300 transform hover:scale-110 ${
              isFavorited 
