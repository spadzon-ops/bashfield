...
export default function ListingCard({
  ...
  const openListing = () => {
    ...
    // Get current page from parent component if available
    const currentPage = Math.ceil(document.querySelectorAll('[data-listing-card]').length / 12) || 1
    sessionStorage.setItem('homePageState', currentPage.toString())
