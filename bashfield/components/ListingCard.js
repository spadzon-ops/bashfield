...
export default function ListingCard({
  ...
  return (
    <div className="bg-white rounded-3xl shadow-lg overflow-hidden group hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 hover:scale-105 border border-gray-100/50 backdrop-blur-sm flex flex-col h-full">
      <div className={`flex flex-col h-full ${!showActions ? 'cursor-pointer' : ''}`} onClick={!showActions ? openListing : undefined}>
