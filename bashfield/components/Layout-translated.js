            ...
            <div className="flex items-center">
              <div className="flex items-center space-x-4 cursor-pointer group" onClick={() => router.push('/')}>
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 hidden sm:block">{t('ui.premierPlatform')}</p>
                </div>
              </div>
            </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  >
                    ...
                    <div className="hidden lg:block">
                      ...
                      <div className="text-xs text-gray-500">{t('nav.viewProfile')}</div>
                    </div>
                  </div>
                  <button 
      ...
      <footer className="bg-gradient-to-r from-gray-900 to-blue-900 text-white mt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
              ...
              <ul className="space-y-3 text-gray-300">
                ...
                <li>
                  <button onClick={() => router.push('/post')} className="hover:text-yellow-400 transition-colors duration-200 flex items-center space-x-2">
                    <span>📝</span><span>{t('nav.addProperty')}</span>
                  </button>
                </li>
                {user && (
                  <li>
          ...
          <div className="border-t border-gray-700 mt-12 pt-8 text-center">
            <p className="text-gray-300 text-lg">&copy; 2025 Bashfield. {t('footer.allRights')}</p>
            <p className="text-yellow-400 mt-2 font-semibold">{t('footer.madeWith')}</p>
          </div>
        </div>
      </footer>
      )}
