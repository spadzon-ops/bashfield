    ...
    <div className="min-h-screen bg-gray-50">
      <nav className="bg-white/95 backdrop-blur-lg shadow-xl border-b border-gray-200/50 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-18">
            <div className="flex items-center">
              <div className="flex items-center space-x-4 cursor-pointer group" onClick={() => router.push('/')}>
                <div className="w-12 h-12 bg-gradient-to-r from-purple-600 via-pink-600 to-indigo-600 rounded-2xl flex items-center justify-center shadow-xl group-hover:shadow-2xl transition-all duration-300 group-hover:scale-110">
                  <span className="text-white font-bold text-2xl group-hover:animate-bounce">🏠</span>
                </div>
                <div>
                  ...
                  <p className="text-xs text-gray-500 hidden sm:block">Iraq's Premier Property Platform</p>
                </div>
              </div>
            </div>
            ...
            <div className="md:hidden flex items-center space-x-3">
              ...
              <button
                ...
                className="text-gray-700 hover:text-purple-600 p-3 relative bg-gray-50 hover:bg-purple-50 rounded-xl transition-all duration-300"
              >
          ...
          {mobileMenuOpen && (
            <div className="md:hidden border-t border-gray-200/50 py-6 bg-gradient-to-b from-white to-gray-50">
      ...
      <footer className="bg-gradient-to-r from-gray-900 to-blue-900 text-white mt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-2">
              ...
              <p className="text-gray-300 mb-6 text-lg leading-relaxed">
                Iraq's premier house rental platform. Find your perfect home across Iraq's major cities with trust and ease.
              </p>
          ...
          <div className="border-t border-gray-700 mt-12 pt-8 text-center">
            <p className="text-gray-300 text-lg">&copy; 2024 Bashfield. All rights reserved.</p>
            <p className="text-yellow-400 mt-2 font-semibold">Made with ❤️ for Iraq</p>
          </div>
        </div>
      </footer>
    </div>
